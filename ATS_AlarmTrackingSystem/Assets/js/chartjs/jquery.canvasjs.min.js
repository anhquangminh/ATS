            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ?
                ...
                (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Aa(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Aa(this._preRenderCtx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = sa(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                    ...
                    this.toolTip = new X(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = {
                        ...
                        axisY: [],
                        axisY2: []
                    })) : window.console && window.console.log(' Chart Container with id "' + this._containerId + '" was not found')
        }
                        ...
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                                if ("number" !== typeof fa.y) B.connectNullData || (aa || x) || d(), aa = !0;
                                    ...
                                    q < w.length - 1 &&
                                        (S !== (w[q].lineColor || y) || z !== (w[q].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({
                                            x: g,
                                            y: m - la
                                    ...
                                    0 <= B.dataPointIndexes[f] &&
                                        0 !== fa.markerSize && (0 < fa.markerSize || 0 < B.markerSize) && (la = B.getMarkerProperties(B.dataPointIndexes[f], g, r, b), l.push(la), f = Q(F), v && l.push({
                                            x: g,
                                            y: r,
                                            ctx: s,
                                            type: la.type,
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                                if ("number" !== typeof fa.y) B.connectNullData || (aa || s) || d(), aa = !0;
                                    ...
                                    s || aa ? (!s && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || t === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (s = k.pop(), t = k[k.length - 1], d(), b.moveTo(m.x, m.y), k.push(t), k.push(s), t = B.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g, r), v && z.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), v && (z.beginPath(), z.moveTo(g, r))),
                                        aa = s = !1) : (b.lineTo(g, r), v && z.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), v && z.moveTo(g, r), k.push({
                                            x: g,
                                            y: x - ba
                                        })));
                                    m = {
                ...
                if (0 !== E) {
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                        ...
                        for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < n.length; c++) {
                            ...
                            e > d && Y(m.plotArea.ctx, g[c].center, g[c].radius, l, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius);
                            if (f) break
                        }
                        h();
                        m.dispatchEvent("dataAnimationIterationEnd", {
        ...
        m.prototype.renderFunnel = function (a) {
            ...
            function m(a, b, c) {
                ...
                if (0 === Y.length) l = ga;
                    ...
                    e = E * (1 != Y.length || 0 != Y[0] && Y[0] != O.length -
                        1 ? 2 : 1) / k();
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                    ...
                    if (-1 !== P) {
                        ...
                        if (t.reversed)
                            for (G = 0; G < P.length; G++) F[G] < wa ? (a.push(K), C.push(W), ca = G) : (a.push((F[G] - ma + $ * X) / $), C.push((F[G] - ma + ea * Z) / ea));
                        else
                        ...
                        for (G = 0; G < P.length - 1; G++) U = t.reversed ?
                            x[x.length - 1 - G].color ? x[x.length - 1 - G].color : t._colorSet[(x.length - 1 - G) % t._colorSet.length] : x[G].color ? x[G].color : t._colorSet[G % t._colorSet.length], G === ca ? O.push({
                                x1: a[G],
                                y1: F[G],
                                x2: C[G],
                                y2: F[G],
